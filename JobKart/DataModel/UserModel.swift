...
class UserDataModel {
    ...
    init(docID: String,name: String,mobile: String,email: String, password:String, organizationType: String,userType: String, orgAddress: String, orgName: String, eduLevel: String, skills: String, orgImageURL: String, aboutMe: String, isBlock: Bool){
        self.docID = docID
        self.name = name
        self.email = email
        self.mobile = mobile
